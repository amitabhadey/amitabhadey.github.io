...
.actions a{ font-size:.82rem; text-decoration:none; padding:.25rem .55rem; border-radius:8px; border:1px dashed rgba(255,255,255,.35); }
...
<section id="aillmtech" class="res-sec">
  ...
  {% assign items = by_card | where_exp:"i","i.tags and i.tags contains tag" | sort:"title" %}
  <ul class="links">
  {% for item in items %}
    <li class="card">
