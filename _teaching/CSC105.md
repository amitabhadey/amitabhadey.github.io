...
This class is a programming-focused class that teaches students to be able to 
critically analyze a dataset using the Python programming language, perform exploratory data analysis, 
try to extract insights from the datasets using conditional filters, grouping, and subsetting of
data frame using packages like pandas and numpy, and then generate visualizations using packages like matplotlib 
and seaborn to utilize quantitative information in the dataset to effectively tell a story and/or 
answer the questions of their research.
