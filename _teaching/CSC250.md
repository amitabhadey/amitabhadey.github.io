...
<tbody>
  ...
  <tr>
    <td class="tg-amwm">Chapter</td>
    <td class="tg-amwm">Topics</td>
    <td class="tg-amwm">Lecture Slides</td>
    <td class="tg-amwm">Notes</td>
  </tr>
  <tr>
    <td class="tg-baqh"><span style="font-style:normal">Functions</span></td>
    <td class="tg-baqh">Polynomial Function<br>Inverse Function<br>Exponential Function<br>Logarithmic Function<br>Mod Function<br>Asymptotic Function<br>Modulus Function</td>
    <td class="tg-baqh"> <a href="https://drive.google.com/file/d/1p0t5kk6H9da-GP7k2GnD-gqnCP9IYUaL/view?usp=sharing">Lecture 1.pdf</a></td>
    <td class="tg-0lax"></td>
  </tr>
  <tr>
    <td class="tg-baqh"><span style="font-style:normal">Security</span></td>
    <td class="tg-baqh">Encryption<br>Types of Cipher: Caesar Cipher, Hill Cipher<br>SQL Injection<br>Hashing<br>Salted Secure Hash Function<br>Hashing Techniques - Division, Multiplication, Mid Square Method<br>Resolving Collision using Linear Probing</td>
    <td class="tg-baqh"><a href="https://drive.google.com/file/d/1I5SyGgD6PAygemtJ_eU_VmRp1HgSaK5N/view?usp=sharing">Lecture 2.pdf</a></td>
    <td class="tg-0lax"></td>
  </tr>
  <tr>
    <td class="tg-baqh"><span style="font-style:normal">Iteration, Induction, and Recursion</span></td>
    <td class="tg-baqh">Selection Sort: An Iterative Sorting Algorithm<br>Proof by Mathematical Induction<br>Merge Sort: A Recursive Sorting Algorithm</td>
    <td class="tg-baqh"><a href="https://drive.google.com/file/d/1ufUF8aUc-wmoGYgLqCBqFATP8QkO2U5T/view?usp=sharing">Lecture 3.pdf</a></td>
    <td class="tg-0lax"></td>
  </tr>
  <tr>
    <td class="tg-baqh"><span style="font-style:normal">Algorithmic Paradigm</span></td>
    <td class="tg-baqh">Brute Force or Exhaustive Search<br>Combinatorial Explosion<br>Travelling Salesman Problem Assignment Problem<br>0-1 and Fractional Knapsack Problem<br>Dynamic Programming - Optimal Substructure, Overlapping Sub-problems<br>House Robber Problem, Karatsuba Alogirthm, Tower of Hanoi<br>Greedy Programming and its limitations<br>Divide and Conquer - Finding Max Element in an Array, Quicksort Algorithm, Binary Search</td>
    <td class="tg-baqh">
    <a href="https://drive.google.com/file/d/1i1_E3qXq3QfAMIgw7M18eZBP_z5VZRyA/view?usp=sharing">Lecture 4.pdf</a><br>
    <a href="https://drive.google.com/file/d/1zqbqloQWhOzokdNNqaA7T1G8JX59w6nu/view?usp=sharing">Lecture 5.pdf</a><br>
    <a href="https://drive.google.com/file/d/1om_yeP3c2diCFPAJ06QnAe93jfeZmTcM/view?usp=sharing">Lecture 6.pdf</a><br>
    <a href="https://drive.google.com/file/d/1jbfI_SIVZUEiFG2xlTo_RHxUsSKFKfhX/view?usp=sharing">Lecture 7.pdf</a></td>
    <td class="tg-0lax"></td>
  </tr>
  <tr>
    <td class="tg-baqh"><span style="font-style:normal">Running Time of Programs</span></td>
    <td class="tg-baqh">Time and Space Complexity<br>Asymptotic Notations<br>Big-Oh notations - Constant, Linear, Quadratic, Logarithmic<br>Calculating Time Complexity<br>Big-Oh Performance Comparisons<br>Logarithms in Running Times<br>Running Times of Simple Statements, For Loops, Nested For Loops</td>
    <td class="tg-baqh"><a href="https://drive.google.com/file/d/1KFAIq6dJ3xq2fFkUE9pNjUIa5lrAPgdc/view?usp=sharing">Lecture 8.pdf</a><br></td>
    <td class="tg-0lax"></td>
  </tr>
  <tr>
    <td class="tg-baqh"><span style="font-style:normal">Combinatorics and Probability</span></td>
    <td class="tg-baqh">Fundamental Counting Principle<br>Permutation (with and without repetition)<br>Combination (with and without repetition)<br>Probabilistic Model and Sample Space<br>Mutually Exclusive and Non Mutually Exclusive Events<br>Independent Events and Dependent Events (Conditional Probability)</td>
    <td class="tg-baqh">
    <a href="https://drive.google.com/file/d/1XrFV5oc1MBuQPmTnWH7xDQwRE3xQX9GH/view?usp=sharing">Lecture 9.pdf</a><br>
    <a href="https://drive.google.com/file/d/1ZvB2qQt3KFN8lgQfjFCL2aDoz5R7f06N/view?usp=sharing">Lecture 10.pdf</a><br>
    <a href="https://drive.google.com/file/d/1mJnteJdcCkuw9BJ6vNWlY18qGrM2SZ86/view?usp=sharing">Lecture 11.pdf</a><br>
    <a href="https://drive.google.com/file/d/1QWOQZnhMbAGIBX9hK2jNSRPVlYJHcBN0/view?usp=sharing">Lecture 12.pdf</a></td>
    <td class="tg-baqh"></td>
  </tr>
  <tr>
    <td class="tg-nrix"><span style="font-style:normal">The Tree Data Model</span></td>
    <td class="tg-nrix">Basic Terminology<br>Data Structures for Trees<br>Binary Trees<br>Binary Search Trees<br>Depth First Search and Breadth-First Search<br>Tree Traversal Techniques - Inorder, Preorder, Postorder<br>Minimal Spanning Trees</td>
    <td class="tg-nrix">
    <a href="https://drive.google.com/file/d/107qYNXTxolVhUJSAp7awRYFqpZl0lXp4/view?usp=sharing">Lecture 13.pdf</a><br>
    <a href="https://drive.google.com/file/d/1nvV98c-jDrFkcA1-vlFj48KLjMGmAP4M/view?usp=sharing">Lecture 14.pdf</a></td>
    <td class="tg-baqh">
    <a href = "https://drive.google.com/file/d/1xKgyMbyndpi1KIfDCQeqkOs1zDbSATkt/view?usp=sharing">BFS Lecture Notes.pdf</a><br>
    <a href = "https://drive.google.com/file/d/1U7KZWaFOnJf0lDDMDeWjdHGdfzbRtq4x/view?usp=sharing">DFS Lecture Notes.pdf</a><br>
    <a href = "https://drive.google.com/file/d/1G4XJigcZSDXLruBe_CDBy7ddt-NQmtge/view?usp=sharing">BST Traversals.pdf</a>
    </td>
  </tr>
  <tr>
    <td class="tg-nrix"><span style="font-style:normal">Compiler Design</span></td>
    <td class="tg-nrix">Context Free Grammars (CFGs)<br>Constructing a Parse Tree<br>Leftmost and Rightmost Derivation<br>Removing Ambiguity in Grammar</td>
    <td class="tg-nrix">
  ...
  <tr>
    <td class="tg-nrix"><span style="font-style:normal">Automata and Computability</span></td>
    <td class="tg-nrix">Regular Expressions<br>State Machines<br>Deterministic Finite Automata (DFA)<br>Non-Deterministic Finite Automata (NFA)<br>Converting NFA to DFA using the Subset Construction Method<br>Mealy Machine and Moore Machine</td>
    <td class="tg-nrix">
    <a href="https://drive.google.com/file/d/1B-RRXs9lBK267E18NX06-tWDoIx5-CSk/view?usp=sharing">Lecture 16.pdf</a></td>
    <td class="tg-baqh">
    <a href = "https://drive.google.com/file/d/1tU48CiQ41fAKMDi4MfLj0uUxuKUG6gH8/view?usp=sharing">DFA NFA 1.pdf</a><br>
    <a href = "https://drive.google.com/file/d/1Mf7GVatDgQd7POsJq6JAD91J6ukCXTpw/view?usp=sharing">DFA NFA 2.pdf</a><br>
    <a href = "https://drive.google.com/file/d/1gOyHDAv7iU0-CUECzfNamnkGjiWmIjcM/view?usp=sharing">DFA NFA 3.pdf</a><br>
    <a href = "https://drive.google.com/file/d/12l7-i_ycbi5Wbx86ur8mYyonLTpJuakj/view?usp=sharing">DFA NFA 4.pdf</a><br>
    <a href = "https://drive.google.com/file/d/1WQvuMgAltaeqDhxOR59GgJ2QsASrUZs0/view?usp=sharing">DFA NFA 5.pdf</a><br>
    <a href = "https://drive.google.com/file/d/1IGzwjcOLYlxjdSVZk6bGXqFqqhZuLmAj/view?usp=sharing">Mealy Moore 1.pdf</a><br>
    <a href = "https://drive.google.com/file/d/1xO_LtrU8w8khrAEuFjeZFuUgOPzb80Jq/view?usp=sharing">Mealy Moore 2.pdf</a>
    </td>
  </tr>
</tbody>
</table>
