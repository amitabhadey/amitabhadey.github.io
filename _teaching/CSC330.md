...
This course introduces students to a comprehensive array of advanced data structures and algorithms essential for solving complex computational problems efficiently. Throughout the course, students delve into topics such as static arrays, concatenation, and permutation, exploring real-world applications like counting good pairs or solving the two-sum problem. They further navigate the realm of 2D arrays, grappling with challenges like determining the richest customer's wealth or finding words containing specific characters. In the realm of hashmap tables, students tackle tasks ranging from identifying the first non-repeating character to merging two sorted arrays. The course also delves into linked-lists, binary trees, heaps, stacks, and graphs, equipping students with essential skills in dynamic programming, syntax parsing, and graph theory. Moreover, students explore fundamental object-oriented concepts like inheritance, polymorphism, and abstract classes, enhancing their proficiency in designing and implementing robust, scalable software systems. Through hands-on exercises, code implementations, and algorithmic analysis, students emerge adept in leveraging advanced data structures to tackle complex computational challenges effectively.

## Instructor and Course Details

Amitabha Dey, a_dey@uncg.edu

Emailing Etiquette: Email is the best way to reach me. Communication via any other medium is discouraged.
...
> Note: Sending emails to your professor or teaching assistants should be treated as professional communication. Emails should have an appropriate greeting and ending; students should refrain from using any kind of “shortcuts”, abbreviations, acronyms, slang, etc. in the email text.
...
Course Modality: The course is designed and planned as a fully in-person class, and not designed to be asynchronous. If you cannot attend the lectures in person, you should consider enrolling in this class.

Graduate TA: Ayodeji Iwayemi, a_iwayemi@uncg.edu
...
- Familiarize oneself with object-oriented concepts like inheritance, polymorphism, virtual functions, and abstract classes, and understand their significance in software design and implementation.
...
<tbody>
  ...
  <tr>
    <td style="text-align: center" class="tg-amwm">Chapter</td>
    <td style="text-align: center" class="tg-amwm">Topics</td>
    <td style="text-align: center" class="tg-amwm">Lecture Slides</td>
    <td style="text-align: center" class="tg-amwm">Notes</td>
  </tr>
  <tr>
    <td style="text-align: center" class="tg-baqh"><span style="font-style:normal">Static Arrays</span></td>
    <td style="text-align: center" class="tg-baqh">Concatenation of Array<br>
Building Array from Permutation<br>
Number of Good Pairs<br>
Two Sum Problem<br>
Final Value of Variable after Performing<br>
Shuffle the Array<br>
Two Dimensional (2D) Arrays<br>
Richest Customer Wealth<br>
Finding Words Containing Characters<br>
Number of Employees who met the target<br>
Kids with the greatest number of candies<br>
Minimum number game<br>
Check if two strings are equivalent<br>
Count Items matching a Rule<br>
</td>
    <td style="text-align: center" class="tg-baqh"> 
    <a href="https://drive.google.com/file/d/1tsDqSKBnDLD9LSiW3RzWCEZl9nO-MihE/view?usp=sharing">Lecture 1.pdf</a><br>
    <a href="https://drive.google.com/file/d/1xKtjBJF2ZR2vaKI6PgiL3o2lku6Q2nqQ/view?usp=sharing">Lecture 2.pdf</a><br>
    <a href="https://drive.google.com/file/d/1_0RY4vh16B2C540aV-b8nrCb5NfQu3BD/view?usp=sharing">Lecture 3.pdf</a><br>
    <a href="https://drive.google.com/file/d/1KVs2t3rLuw4DvtSlax_1dPygcen2DG1_/view?usp=sharing">Lecture 4.pdf</a><br>
    </td>
<td style="text-align: center" class="tg-baqh"></td>
  ...
  <tr>
    ...
    <td style="text-align: center" class="tg-baqh">First Non-Repeating Character<br>
Check if Two Strings are Anagrams<br>
Count Distinct Absolute Values in a Sorted Array<br>
Find the Second Minimum Element in an Array<br>
First Non-Repeating Integer in an Array<br>
Merge Two Sorted Arrays<br>
  ...
  <tr>
    ...
    <td style="text-align: center" class="tg-baqh">Anatomy of LinkedLists - nodes, pointers<br>
Convert Binary Number in a Linked List to Integer<br>
Reverse Linked List<br>
Middle of the Linked List<br>
Remove Linked List Elements<br>
Dynamic Arrays, Circular Buffers, Sparse Arrays, Amortized Analysis<br>
</td>
  ...
  <tr>
    ...
    AVL Trees<br>
Red-Black Trees<br>
B-Trees, 2-3-4 Trees<br>
</td>
<td style="text-align: center" class="tg-nrix"></td>
    <td style="text-align: center" class="tg-baqh">
    <a href="https://drive.google.com/file/d/1F0cNNQLzWDJkzllzvhVfCD59L9ZtT4g2/view?usp=sharing">avl tree notes.pdf</a><br>
    <a href="https://drive.google.com/file/d/1ZhBJI90ZUH0uEocXC4imWnkTJ1XKPZtU/view?usp=sharing">red black tree notes.pdf</a><br>
    <a href="https://drive.google.com/file/d/1S0dKzX1UVjJmNe0oJ7d7ObUGXVDsFJeJ/view?usp=sharing">b-trees notes.pdf</a><br>
    <td style="text-align: center" class="tg-0lax"></td>
  </tr>
  <tr>
    <td style="text-align: center" class="tg-baqh"><span style="font-style:normal">Heaps</span></td>
    <td style="text-align: center" class="tg-baqh">Max Heap and Min Heap<br>
Building Heap from an unordered array<br>
Heap Sort<br>
Priority Queues<br>
<td style="text-align: center" class="tg-nrix"></td>
</td>
    <td style="text-align: center" class="tg-baqh">
    <a href="https://drive.google.com/file/d/1DSO3Hv32BtNJr9UlHpq8JJJvXE-XZsrz/view?usp=sharing">heap notes.pdf</a><br>
    <a href="https://drive.google.com/file/d/1nvRfV_64yIbMZ45oWZlzpljtZYbh5T-s/view?usp=sharing">heap sort notes.pdf</a><br>
    <a href="https://drive.google.com/file/d/1A16sIKurqWGcj0rV4MiVoYLALspVj9pe/view?usp=sharing">priority queue notes.pdf</a><br>
  ...
  <tr>
    ...
    <td style="text-align: center" class="tg-baqh">Operations - Push, Pop, Top, IsEmpty<br>
