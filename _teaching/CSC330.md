...
<table class="tg" style="width:100%">
  <tbody>
    <tr>
      <td style="text-align: center; width:15%" class="tg-amwm">Chapter</td>
      <td style="text-align: center; width:25%%" class="tg-amwm">Topics</td>
      <td style="text-align: center; width:30%" class="tg-amwm">Lecture Slides</td>
      <td style="text-align: center; width:30%" class="tg-amwm">Notes</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align: center" class="tg-baqh">
        ...
        <a href="https://drive.google.com/file/d/1A16sIKurqWGcj0rV4MiVoYLALspVj9pe/view?usp=sharing">priority queue notes.pdf</a><br><br>
      </td>
    </tr>
    <tr>
