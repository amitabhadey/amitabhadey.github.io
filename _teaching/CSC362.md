...
<div style="text-align: center;">
  <!-- Embed PDF -->
  <div id="pdf-container" style="display: block; margin: 0 auto;">
    <iframe
      src="_teaching/doc/CSC362 - Course Plan.pdf"
      style="width: 100%; max-width: 600px; height: 800px; border: none;"
      title="Course Plan"
    >
    </iframe>
  </div>
  ...
  <!-- Fallback for Mobile -->
  <div id="pdf-fallback" style="display: none; margin-top: 10px;">
    <p style="font-size: 16px;">It seems your device doesn't support embedded PDFs. Please download the file to view it:</p>
    <a href="_teaching/doc/CSC362 - Course Plan.pdf" download>
...
<script>
  // Detect if the browser supports embedded PDFs
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (
      ...
      // Hide the embed and show fallback
